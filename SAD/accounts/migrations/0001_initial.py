    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('دکتری', 'دکتری'), ('کارشناسی', 'کارشناسی'), ('کارشناسی\u200cارشد', 'کارشناسی ارشد'), ('تخصص', 'تخصص'), ('فوق\u200cتخصص', 'فوق تخصص'), ('-', '-')], default='-', max_length=254, null=True)),
                ...
                ('credit', models.FloatField(blank=True, default=0, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('visit_duration', models.FloatField(choices=[(1, 'یک ساعت'), (0.5, 'نیم ساعت'), (0.75, 'سه ربع')], default=0.5)),
                ('available_weekdays', models.CharField(default='1111100', max_length=8)),
                ('start_hour', models.IntegerField(default=8, validators=[django.core.validators.MaxValueValidator(20), django.core.validators.MinValueValidator(8)])),
                ('end_hour', models.IntegerField(default=20, validators=[django.core.validators.MaxValueValidator(20), django.core.validators.MinValueValidator(9)])),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
